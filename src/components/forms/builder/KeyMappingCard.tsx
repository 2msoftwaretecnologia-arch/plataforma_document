...
import type { FieldType, KeyFieldMapping } from "@/types/ui/form";
        ...
        <Collapse in={!!mapping.formFieldType && !!mapping.formFieldConfig}>
          ...
          >
            ...
            {mapping.formFieldType === 'text' && mapping.formFieldConfig && (
              <TextFieldConfig
                config={mapping.formFieldConfig as Partial<import('@/types/ui/form').TextFieldData>}
            ...
            {mapping.formFieldType === 'number' && mapping.formFieldConfig && (
              <NumberFieldConfig
                config={mapping.formFieldConfig as Partial<import('@/types/ui/form').NumberFieldData>}
                onChange={(c) => onConfigChange(c as typeof mapping.formFieldConfig)}
              />
            )}
            ...
            {mapping.formFieldType === 'date' && mapping.formFieldConfig && (
              <DateFieldConfig
                config={mapping.formFieldConfig as Partial<import('@/types/ui/form').DateFieldData>}
                onChange={(c) => onConfigChange(c as typeof mapping.formFieldConfig)}
              />
            )}
            ...
            {mapping.formFieldType === 'list' && mapping.formFieldConfig && (
              <ListFieldConfig
                config={mapping.formFieldConfig as Partial<import('@/types/ui/form').ListData>}
                onChange={(c) => onConfigChange(c as typeof mapping.formFieldConfig)}
              />
            )}
            ...
            {mapping.formFieldType === 'image' && mapping.formFieldConfig && (
              <ImageFieldConfig
                config={mapping.formFieldConfig as Partial<import('@/types/ui/form').ImageFieldData>}
                onChange={(c) => onConfigChange(c as typeof mapping.formFieldConfig)}
              />
            )}
          </Box>
